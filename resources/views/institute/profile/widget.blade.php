<div class="box box-widget widget-user">
  ...
  <div class="media-selector-wrapper" data-non-image-error="{{ trans('inoplate-account::messages.profile.avatar_must_be_image') }}">
    ...
    <div class="widget-user-image media-selector">
      <img class="img-circle" src="{{ $profile['avatar'] or '/vendor/inoplate-adminutes/img/user-128x128.png' }}" alt="User Avatar">
      <div class="overlay img-circle">
        <i class="fa fa-image"></i>
      </div>
      <input type="hidden" name="avatar" value="{{ $profile['avatar'] or '/vendor/inoplate-adminutes/img/user-128x128.png' }}"/>
    </div>
  </div>
