...
@php($title = 'Tambah jurusan baru')

@addJs('institute/department/create.js')
    ...
    <section class="content">
        <div class="row">
            <div class="col-md-12">
                ...
                <form class="ajax" method="post" action="/admin/institute/department" id="department-create-form">
                    <div class="box-body">
