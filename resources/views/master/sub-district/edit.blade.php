    ...
    <section class="content">
        <div class="row">
            <div class="col-md-12">
                ...
                <form class="ajax no-reset" method="post" action="{{route('admin.master.sub-district.update', ['sub-district' => $subDistrict->id])}}" id="sub-district-update-form">
                    <div class="box-body">
